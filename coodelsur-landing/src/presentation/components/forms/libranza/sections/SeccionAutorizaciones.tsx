...
const SignaturePad = dynamic(
  () => import("@/presentation/components/forms/SignaturePad").then((m) => m.SignaturePad),
  {
    ssr: false,
...
export function SeccionAutorizaciones() {
  const { control, setValue } = useFormContext<LibranzaFormValues>();
